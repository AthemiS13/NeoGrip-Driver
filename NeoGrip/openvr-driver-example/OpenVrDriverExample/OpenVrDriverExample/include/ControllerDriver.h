...
This example driver will simulate a controller that has a joystick and buttons on it.
**/
...
private:
    ...
    // Button components
    VRInputComponentHandle_t buttonXHandle;
    VRInputComponentHandle_t buttonYHandle;
    VRInputComponentHandle_t buttonMenuHandle;
    VRInputComponentHandle_t buttonTriggerHandle;
    VRInputComponentHandle_t buttonGrabHandle;
    VRInputComponentHandle_t joystickClickHandle;
    VRInputComponentHandle_t systemClickHandle;
};
